...
def index(request):
    return render(request, "classProjects/index.html")

def places(request):
    return render(request, "classProjects/mapPlaces.html")

def quiz(request):
    return render(request, "classProjects/quiz.html")
...
def login_view(request):
    if request.method == "POST":
        ...
        if user is not None:
            ...
            return render(request, "classProjects/login.html", {
...
def register(request):
    if request.method == "POST":
        ...
        if password != confirmation:
            return render(request, "classProjects/register.html", {
